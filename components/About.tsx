          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left items-start">
            <motion.div variants={itemVariants} className="lg:col-span-7">
              ...
              <div className="mt-8 flex gap-4">
                 <button className="group flex items-center font-medium text-[17px] px-[1.5em] py-[0.8em] pl-[1.2em] text-white bg-black border-2 border-black rounded-full shadow-[0_0_0_0_rgba(0,0,0,0.5)] transition-all duration-300 hover:border-white hover:shadow-[0_0.5em_1.5em_-0.5em_rgba(0,0,0,0.5)] active:shadow-[0_0.3em_1em_-0.5em_rgba(0,0,0,0.5)] active:scale-95">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="mr-2 w-5 h-5 fill-current">
